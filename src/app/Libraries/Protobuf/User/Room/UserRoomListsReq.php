 ...
 *用户楼栋号列表展示
 *
 * Generated from protobuf message <code>user.room.UserRoomListsReq</code>
 */
class UserRoomListsReq extends \Google\Protobuf\Internal\Message
{
    /**
     *用户id
     *
     ...
     *是否自有
     *
     * Generated from protobuf field <code>.user.Enumerate owner = 8;</code>
     */
    private $owner = 0;
